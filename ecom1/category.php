...
.card:hover {
    ...
    <body style="padding-bottom:350px;">
        <?php include 'includes/navbar.php' ?>
        <div class="mainbody" style="padding-bottom:50px;">
            <?php
                $count=0;
                $query1="SELECT * FROM category WHERE id=$catid";
                ...
                if($count == 4){include 'includes/sidebar.php';}
            }
            ?>
            <?php if($count < 4){include 'includes/sidebar.php';}?>
        </div>
